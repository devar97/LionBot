...
if is_chat_msg(msg) or is_super_group(msg) then
	...
	if settings.strict then
		...
		if msg.text then -- msg.text checks
			...
			if lock_spam == "yes" and string.len(msg.text) > 1200 or ctrl_chars > 18 or real_digits > 1000 then
					 local warn = "‼️ تم الكشف عن وجود تفليش ‼️\n".."\n".."🔹 الأسم : "..msg.from.first_name.."\n".."🔹 المعرف : @"..msg.from.username.."\n"
					delete_msg(msg.id, ok_cb, false)
                      reply_msg(msg.id, warn, ok_cb, true) 
