...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
      local text = '🛡 تم تفعيل ☑️ المجموعه 🚀'
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
      local text = 'تــTMــم تعطيل المجموعه 😌✋'
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local title ="‼️ معلومات عن المجموعه ❕\n ["..result.title.."]\n\n"
local admin_num = "🔺 عدد الأدمنيه 🔺-: "..result.admins_count.."\n"
local user_num = "🔺 عدد الأعضاء 🔺-:"..result.participants_count.."\n"
local kicked_num = "🔺 عدد المتفاعلين 🔺-: "..result.kicked_count.."\n"
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    return '🛡 الاضافه الجماعيه مقفوله عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    return '🛡 الاضافه الجماعيه مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    return '🛡 الملصقات مقفوله عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    return '🛡 الملصقات مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    return '🛡 جهات الاتصال مقفوله عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    return '🛡 جهات الاتصال مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    return '🛡 جميع الأعدادات مقفوله عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
    data[tostring(target)]['settings']['strict'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🛡 تم قفل 🔐 جميع الأعدادات 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    return '🛡 جميع الأعدادات مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  else
    data[tostring(target)]['settings']['strict'] = 'no'
    save_data(_config.moderation.data, data)
    return '🛡 تم فتح 🔓 جميع الأعدادات 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
  end
end
...
local function promote_admin(receiver, member_username, user_id)
  ...
  if data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_username..' موجود بالادمنيه لتلح 😼 ')
  end
...
local function promote2(receiver, member_username, user_id)
  ...
  if data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_username..' ☑️ هو بالفعل ضمن الأدمنيه ☑️  ')
  end
  data[group]['moderators'][tostring(user_id)] = member_tag_username
  save_data(_config.moderation.data, data)
...
local function demote2(receiver, member_username, user_id)
  ...
  if not data[group]['moderators'][tostring(user_id)] then
     return send_large_msg(receiver, member_username..' اصلا هوه مواصل لهاي المرحله 😹🔫 ')
  end
  data[group]['moderators'][tostring(user_id)] = nil
  save_data(_config.moderation.data, data)
...
function get_message_callback(extra, success, result)
    ...
    elseif get_cmd == "رفع المدير" then
        ...
        local channel_id = 'channel#id'..result.to.peer_id
            ...
            if result.from.username then
                text = "@"..result.from.username.." [ "..result.from.peer_id.." ]   رفعوك مدير  سمعني الهلهوله 😹 😌  "
            else
                text = "[ "..result.from.peer_id.." ]   رفعوك مدير  سمعني الهلهوله 😹 😌  "
            end
            send_large_msg(channel_id, text)
        end
    ...
    for k,v in pairs(result) do
        ...
        if vusername == member or vpeer_id == memberid then
            ...
            if group_owner then
                ...
                if result.username then
                    text = member_username.." ["..v.peer_id.."]  ☑️ تم رفع مدير للمجموعه ☑️  "
                else
                    text = "["..v.peer_id.."]  ☑️ تم رفع مدير للمجموعه ☑️  "
                end
            end
        elseif memberid and vusername ~= member and vpeer_id ~= memberid then
            ...
            if group_owner then
                ...
                text = "["..memberid.."]  ☑️ تم رفع مدير للمجموعه ☑️  "
            end
        end
    end
 end
    ...
    local data = load_data(_config.moderation.data)
        if matches[1] == 'تفعيل' and not matches[2] then
            ...
            if is_super_group(msg) then
                return reply_msg(msg.id, '🛡 المجموعه مفعله عزيزي ☑️', ok_cb, false)
            end
        ...
        if matches[1] == 'تعطيل' and is_admin1(msg) and not matches[2] then            if not is_super_group(msg) then
                return reply_msg(msg.id, '🛡 المجموعه غير مفعله عزيزي ☑️', ok_cb, false)
            end
        ...
        if matches[1] == 'رفع ادمن' then
          if not is_momod(msg) then
            ...
            if not is_owner(msg) then
                return " \n".. ":{" ..msg.from.first_name.. "}:".."\n".."\n".."⚠️ لتلعب بكيفك 👐 فقط الادمنيه 👍 يحق لهم ذلك 😽✋"
            end
            if type(msg.reply_id) ~= "nil" then
                local cbreply_extra = {
                    get_cmd = 'رفع ادمن',
        ...
        if matches[1] == 'تنزيل ادمن' then
            ...
            if not is_owner(msg) then
                return " \n".. ":{" ..msg.from.first_name.. "}:".."\n".."\n".."اكعد راحه ابن ام الروبه 😹 بس للادمنيه"
            end
            if type(msg.reply_id) ~= "nil" then
                local cbreply_extra = {
                    get_cmd = 'تنزيل ادمن',
        ...
        if matches[1] == 'مسح' then
            ...
            if not is_momod(msg) then
                return "اكعد راحه 😒 سوالف مال كبار 🐸☝🏿️"
            end
            ...
            if matches[2] == 'الوصف' then
                ...
                local data_cat = 'description'
                if data[tostring(msg.to.id)][data_cat] == nil then
                return  " عزيزي 🌝".. ":{" ..msg.from.first_name.. "}:".."\n".."\n".."❌ لايوجد وصف لايمكنني المسح ❌"
                end
                data[tostring(msg.to.id)][data_cat] = nil
                save_data(_config.moderation.data, data)
                savelog(msg.to.id, name_log.." ["..msg.from.id.."] cleaned about")
                channel_set_about(receiver, about_text, ok_cb, false)
                return " ☑️ تم مسح الوصف 🚀  ".."\n🔺الأمر بواسطة : "..msg.from.first_name.."\n🔻الأمر بواسطة  : @"..msg.from.username.."\n"
            end
            if matches[2] == 'المكتومين' then
                chat_id = msg.to.id
                local hash =  'mute_user:'..chat_id
                    redis:del(hash)
            return " ☑️ تم مسح قائمة المكتومين 🚀 ".."\n🔺الأمر بواسطة : "..msg.from.first_name.."\n🔻الأمر بواسطة  : @"..msg.from.username.."\n"
            end
            if matches[2] == 'المعرف' and is_admin1(msg) then
                local function ok_username_cb (extra, success, result)
                    ...
                    elseif success == 0 then
                        send_large_msg(receiver, " عذراً 🌝".. ":{" ..msg.from.first_name.. "}:".."\n".."\n".."❌ فشل ⚠️ مسح معرف المجموعه")
                    end
                end
                local username = ""
                channel_set_username(receiver, username, ok_username_cb, {receiver=receiver})
        ...
        if matches[1] == 'ضع تكرار' then
            ...
            if tonumber(matches[2]) < 5 or tonumber(matches[2]) > 20 then
                return  " عزيزي 🌝".. ":{" ..msg.from.first_name.. "}:".."\n".."\n".."🔻 ضع تكرار من {5 ـ 20} 😘☝️🔺"
            end
            local flood_max = matches[2]
            data[tostring(msg.to.id)]['settings']['flood_msg_max'] = flood_max
            save_data(_config.moderation.data, data)
            savelog(msg.to.id, name_log.." ["..msg.from.id.."] set flood to ["..matches[2].."]")
            return " ✅ تم  تعيين التكرار للعدد " .." {" ..matches[2].. "} ".."\n🔺الأمر بواسطة : "..msg.from.first_name.."\n🔻الأمر بواسطة  : @"..msg.from.username.."\n"
             end
        ...
        if matches[1] == 'قفل' and is_momod(msg) then
            ...
            local msg_type = 'Audio'
                if not is_muted(chat_id, msg_type..': yes') then
                    ...
                    return msg_type..'   🛡 تم قفل 🔐 الصوت 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return ""..msg_type..'   🛡 الصوت مقفول عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            ...
            local msg_type = 'Photo'
                if not is_muted(chat_id, msg_type..': yes') then
                    ...
                    return ""..msg_type..'  🛡 الصور مقفوله عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            ...
            local msg_type = 'Video'
                if not is_muted(chat_id, msg_type..': yes') then
                    ...
                    return ""..msg_type..'  🛡 الفيديو مقفول عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            ...
            local msg_type = 'Gifs'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                    return msg_type..'  🛡 تم قفل 🔐 الصور المتحركه 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return ""..msg_type..'   🛡 الصور المتحركه مقفول عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            ...
            local msg_type = 'Documents'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                    return msg_type..'   🛡 تم قفل 🔐 الفايلات 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return ""..msg_type..'  🛡 الفايلات مقفوله عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            ...
            local msg_type = 'Text'
                if not is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
                    mute(chat_id, msg_type)
                    return msg_type..'  🛡 تم قفل 🔐 الدردشه 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return ""..msg_type..'  🛡 الدردشه مقفوله عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            ...
            local msg_type = 'All'
                if not is_muted(chat_id, msg_type..': yes') then
                    ...
                    return "Mute "..msg_type..'  🛡 المجموعه مقفوله عزيزي ☑️ \n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
        end
        if matches[1] == 'فتح' and is_momod(msg) then
            ...
            local msg_type = 'Audio'
                if is_muted(chat_id, msg_type..': yes') then
                    ...
                    return msg_type..'   🛡 تم فتح 🔓 الصوت 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return ""..msg_type..'  🛡 الصوت مفتوح عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            ...
            local msg_type = 'Photo'
                if is_muted(chat_id, msg_type..': yes') then
                    ...
                    return ""..msg_type..'  🛡 الصور مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            if matches[2] == 'الفيديو' then
            local msg_type = 'Video'
                if is_muted(chat_id, msg_type..': yes') then
                    ...
                    return ""..msg_type..'  🛡 الفيديو مفتوح عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            if matches[2] == 'المتحركه' then
            local msg_type = 'Gifs'
                if is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
                    unmute(chat_id, msg_type)
                    return msg_type..'  🛡 تم فتح 🔓 الصور المتحركه 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return ""..msg_type..'  🛡 الصور المتحركه مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            if matches[2] == 'الفايلات' then
            local msg_type = 'Documents'
                if is_muted(chat_id, msg_type..': yes') then
                    ...
                    return ""..msg_type..'  🛡 الفايلات مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            if matches[2] == 'الدردشه' then
            local msg_type = 'Text'
                if is_muted(chat_id, msg_type..': yes') then
                    ...
                    unmute(chat_id, msg_type)
                    return msg_type..'  🛡 تم فتح 🔓 الدردشه 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return '  🛡 الدردشه مفتوحه عزيزي ☑️  \n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
            if matches[2] == 'المجموعه' then
            local msg_type = 'All'
                if is_muted(chat_id, msg_type..': yes') then
                    savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
                    unmute(chat_id, msg_type)
                    return " "..msg_type..'  🛡 تم فتح 🔓 المجموعه 🚀\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                else
                    return " "..msg_type..'  🛡 المجموعه مفتوحه عزيزي ☑️\n🔺الأمر بواسطة : @'..msg.from.username..'\n🔻الأمر بواسطة : '.. msg.from.id..'\n'
                end
            end
        end
